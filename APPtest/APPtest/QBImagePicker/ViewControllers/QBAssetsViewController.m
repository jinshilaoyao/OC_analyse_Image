...
//    QBAssetCell *qBAssetCell = (QBAssetCell*)[collectionView cellForItemAtIndexPath:indexPath];
//    if(!CGRectContainsPoint(qBAssetCell.selectImageView.frame,qBAssetCell.touchePoint))
//    {
//        UIImage *image = [UIImage imageWithCGImage:asset.defaultRepresentation.fullResolutionImage
//                                             scale:asset.defaultRepresentation.scale
//                                       orientation:(UIImageOrientation)asset.defaultRepresentation.orientation];
//        [qBAssetCell.imageView showFullScreenImageViewWithImage:image];
//        return NO;
//    }
    ...
    {
        //添加提示
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:nil message:[NSString stringWithFormat:@"你最多只能选择%zd张照片",self.imagePickerController.maximumNumberOfSelection] delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil];
